...
<head>
    ...
    <meta name="description" content="delivery control sipariş kontrol sistemi">
    <meta name="keywords" content="sipariş kontrol listesi, sipariş, sipariş kontrol, delivery control">
    <meta name="author" content="Erhan Baştürk">
...
<body>
    <div class="landing">
        <nav class="navbar navbar-expand-lg">
            <div class="container mt-2 navbar-content">
                <a class="navbar-brand" href="index.php">Delivery-Control</a>
                <div>
                    <ul class="navbar-nav">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" target="_blank" href="https://github.com/basturkerhan/delivery-control-project">Github</a>
                        </li>
                    </ul>
                </div>
            </div>
